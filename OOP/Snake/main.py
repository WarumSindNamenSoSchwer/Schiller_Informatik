...
class Snake:
    ...
    def up(self):
        ...
        if self.head.direction != 270:
            self.head.dx = 0
            self.head.dy = SQUARE_SIZE

    def down(self):
        """Changes the snake's direction to down."""
        if self.head.direction != 90:
            self.head.dx = 0
            self.head.dy = -SQUARE_SIZE

    def left(self):
        """Changes the snake's direction to left."""
        if self.head.direction != 0:
            self.head.dx = -SQUARE_SIZE
            self.head.dy = 0

    def right(self):
        """Changes the snake's direction to right."""
        if self.head.direction != 180:
            self.head.dx = SQUARE_SIZE
            self.head.dy = 0
...
class Game:
    ...
    def check_collision(self):
        """Checks for collisions with borders and snake body."""
